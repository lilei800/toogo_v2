<template>
  <div
    ...
    class="tabs-view tabs-view-border-radius"
    :class="{
            ...
            <template #item="{ element, index }">
              ...
              >
                ...
                <span
                  ...
                  v-if="settingStore.isMultiTabsIcon && element.meta.icon"
                >
...
<script lang="ts" setup>
  ...
  const { getNavMode, getNavWidth, getNavMinWidth, getBorderRadius } = useProjectSetting();
