<template>
  <div class="vip-level-admin-page">
    ...
    <!-- 编辑弹窗 -->
    <n-modal v-model:show="showEditModal" :title="editForm.id ? '编辑VIP等级' : '新增VIP等级'" preset="card" style="width: 600px">
        ...
        <n-grid :cols="2" :x-gap="16">
          ...
          <n-gi>
            <n-form-item label="邀请人数">
              <n-input-number v-model:value="editForm.requireInviteCount" :min="0" style="width: 100%" />
            </n-form-item>
          </n-gi>
          <n-gi>
            <n-form-item label="消耗算力">
              <n-input-number v-model:value="editForm.requireConsumePower" :min="0" :precision="2" style="width: 100%" />
            </n-form-item>
          </n-gi>
          <n-gi>
            <n-form-item label="团队消耗">
              <n-input-number v-model:value="editForm.requireTeamConsume" :min="0" :precision="2" style="width: 100%" />
            </n-form-item>
          </n-gi>
          <n-gi :span="2">
          ...
          <n-gi>
            <n-form-item label="算力折扣%">
              <n-input-number v-model:value="editForm.powerDiscount" :min="0" :max="30" :precision="2" style="width: 100%" />
            </n-form-item>
          </n-gi>
          <n-gi>
            <n-form-item label="邀请奖励算力">
              <n-input-number v-model:value="editForm.inviteRewardPower" :min="0" :precision="2" style="width: 100%" />
            </n-form-item>
          </n-gi>
          <n-gi :span="2">
...
const columns = [
  { title: '等级', key: 'level', render: (row: any) => h(NTag, { type: 'warning' }, { default: () => `V${row.level}` }) },
