          ...
          <div class="subscription-info">
            <div class="subscription-item" @click="$router.push('/toogo/subscription')">
              ...
              <div class="sub-content">
                ...
                <div class="sub-label">{{
                  subscriptionInfo.planName ? '订阅有效期' : '请购买订阅'
                }}</div>
      ...
      <template #header>
        <div style="display: flex; justify-content: space-between; align-items: center">
          ...
          <n-text depth="3" style="font-size: 12px">
            已完成 <span style="color: #18a058; font-weight: 600">{{ completedStepsCount }}</span
            >/6 步
          </n-text>
        </div>
      </template>
...
<script setup lang="ts">
  ...
  const accountTypeOptions = [
    { label: '余额账户', value: 'balance' },
    { label: '佣金账户', value: 'commission' },
  ];
