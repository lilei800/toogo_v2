...
new_engine_func = r'''func (e *RobotEngine) updateOrderStatusAfterClose(ctx context.Context, pos *exchange.Position, closeOrder *exchange.Order, closeType string) {
\trobot := e.Robot
...
new_robot_func = r'''func (s *sToogoRobot) updateOrderAfterManualClose(ctx context.Context, robotId int64, positionSide string, closePrice, realizedProfit float64, exchangeCloseId string) {
\t// 确定方向
\tdirection := "long"
