...
> **适用于：** hotgo_v2 量化交易系统  
> **服务器：** Vultr Tokyo (Ubuntu 22.04 LTS)  
> **预计时间：** 60-90分钟  
> **难度：** ⭐⭐⭐ 中等
...
┌─────────────────────────────────────────────────┐
│           Vultr Tokyo Server                    │
│  OS: Ubuntu 22.04 LTS, 4核8G128G NVMe           │
├─────────────────────────────────────────────────┤
│  Internet (80, 443)                             │
│       ↓                                         │
│  Nginx (反向代理 + SSL)                         │
...
```yaml
server:
  address: "127.0.0.1:8000"  # 只监听本地，通过 Nginx 代理
...
database:
  default:
    ...
    port: "5432"
    user: "hotgo_user"
    pass: "YOUR_STRONG_PASSWORD_HERE"  # PostgreSQL 密码
    name: "hotgo"
    type: "pgsql"
    role: "master"
    debug: false
...
redis:
  default:
    ...
    db: 0
    pass: "YOUR_REDIS_PASSWORD_HERE"  # Redis 密码
...
现在你的 hotgo_v2 量化交易系统已经成功部署到生产环境！
...
**获取帮助：**
- 查看日志：`sudo journalctl -u hotgo -f`
- 问题排查：参考"故障排查"章节
- 联系支持：（添加你的联系方式）
