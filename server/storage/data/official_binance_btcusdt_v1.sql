...
DELETE FROM `hg_trading_strategy_template` WHERE `group_id` IN (
  SELECT `id` FROM `hg_trading_strategy_group` WHERE `group_key` = 'official_binance_btcusdt_v1'
);
DELETE FROM `hg_trading_strategy_group` WHERE `group_key` = 'official_binance_btcusdt_v1';
...
INSERT INTO `hg_trading_strategy_template` (
  ...
  @group_id, 'binance_btc_conservative_trend', '🛡️ 保守-趋势跟踪',
  'conservative', 'trend',
...
INSERT INTO `hg_trading_strategy_template` (
  ...
  @group_id, 'binance_btc_conservative_volatile', '🛡️ 保守-区间震荡',
...
INSERT INTO `hg_trading_strategy_template` (
  ...
  @group_id, 'binance_btc_conservative_high_vol', '🛡️ 保守-高波动防守',
...
INSERT INTO `hg_trading_strategy_template` (
  ...
  @group_id, 'binance_btc_conservative_low_vol', '🛡️ 保守-低波动蓄力',
...
INSERT INTO `hg_trading_strategy_template` (
  ...
  @group_id, 'binance_btc_balanced_trend', '⚖️ 平衡-趋势跟踪 ⭐推荐',
  'balanced', 'trend',
...
INSERT INTO `hg_trading_strategy_template` (
  ...
  @group_id, 'binance_btc_balanced_volatile', '⚖️ 平衡-区间套利',
  'balanced', 'volatile',
...
INSERT INTO `hg_trading_strategy_template` (
  ...
  @group_id, 'binance_btc_balanced_high_vol', '⚖️ 平衡-波动捕捉',
  'balanced', 'high_vol',
...
INSERT INTO `hg_trading_strategy_template` (
  ...
  @group_id, 'binance_btc_balanced_low_vol', '⚖️ 平衡-突破等待',
  'balanced', 'low_vol',
...
INSERT INTO `hg_trading_strategy_template` (
  ...
  @group_id, 'binance_btc_aggressive_trend', '🚀 激进-趋势冲锋',
  'aggressive', 'trend',
...
INSERT INTO `hg_trading_strategy_template` (
  ...
  @group_id, 'binance_btc_aggressive_volatile', '🚀 激进-双向博弈',
  'aggressive', 'volatile',
...
INSERT INTO `hg_trading_strategy_template` (
  ...
  @group_id, 'binance_btc_aggressive_high_vol', '🚀 激进-极速博弈',
  'aggressive', 'high_vol',
...
INSERT INTO `hg_trading_strategy_template` (
  ...
  @group_id, 'binance_btc_aggressive_low_vol', '🚀 激进-突破狙击',
  'aggressive', 'low_vol',
